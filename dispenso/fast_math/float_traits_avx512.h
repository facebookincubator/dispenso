...
DISPENSO_INLINE Avx512Float rsqrt_approx(Avx512Float x) {
  return _mm512_rsqrt14_ps(x.v);
}

DISPENSO_INLINE Avx512Float rsqrt(Avx512Float x) {
  Avx512Float y = _mm512_rsqrt14_ps(x.v);
