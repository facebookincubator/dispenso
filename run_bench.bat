...
python -u scripts\run_benchmarks.py --build -o benchmark_results.json --cmake-args="-G" --cmake-args="Visual Studio 18 2026" --cmake-args="-A" --cmake-args="x64" --cmake-args="-DCMAKE_PREFIX_PATH=C:/vcpkg/installed/x64-windows" --cmake-args="-DCMAKE_DISABLE_FIND_PACKAGE_OpenMP=ON"
